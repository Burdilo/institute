...
define('IS_SPA', false);
define('ADMIN_DIR', 'cp');
define('TEMPLATING', 'Twig'); // PHP | Smarty | Fenom | Twig | Html
define('SITE_THEME', 'base');
define('SITE_NAME', 'SITE «CELEBRO.CMF»');
define('GZIP_COMPRESS', true);
define('CSRF_PROTECTION', true);
define('DEFAULT_LANGUAGE', 'ru');
define('SEARCH_VAR', 'q');
define('ADMIN_EMAIL', 'ed.proff@gmail.com');
...
define('PATH_SYSTEM', dirname(PATH_ROOT));
